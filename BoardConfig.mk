...
BOARD_BOOTIMAGE_PARTITION_SIZE := 50603008 
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 50603008 
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_SYSTEMIMAGE_PARTITION_TYPE := ext4
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
TARGET_COPY_OUT_VENDOR := vendor
BOARD_SUPER_PARTITION_SIZE := 3000000000 # TODO: Fix hardcoded value
BOARD_SUPER_PARTITION_GROUPS := ikall_dynamic_partitions
BOARD_IKALL_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product
BOARD_IKALL_DYNAMIC_PARTITIONS_SIZE := 2998622700 # TODO: Fix hardcoded value
